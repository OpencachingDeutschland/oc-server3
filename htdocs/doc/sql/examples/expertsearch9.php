...
sql('CREATE TEMPORARY TABLE result_caches (`cache_id` int(11) NOT NULL, `search_time` double default NULL, `status` int(11) default NULL, PRIMARY KEY (cache_id)) ENGINE=MEMORY SELECT cache_id, search_time, status FROM caches');
