...
<div id="content">
    <h1><?= $errtitle ?></h1>
    <p>Entschuldigung, bei der Darstellung der Seite ist ein intener Fehler aufgetreten.
        Falls dieses Problem für längere Zeit bestehen sollte, informiere uns bitte per
        <a href="mailto:kontakt@opencaching.de">Email</a>.
    </p>
    <p class="errormsg"><?= $errmsg ?></p>
    <p><a href="index.php">Zurück zur Startseite</a></p>

    <p><br/><br/>
        <em>An error occured while displaying the requested page.
