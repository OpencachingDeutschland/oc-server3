...
//-->
		  ...
		  <div class="content2-pagetitle"><img src="lang/de/ocstyle/images/description/22x22-logs.png" style="margin-right: 10px;" width="22" height="22" alt="" />{t}Add log-entry for the cache <a href="viewcache.php?cacheid={cacheid}">{cachename}</a>{/t}</div>
