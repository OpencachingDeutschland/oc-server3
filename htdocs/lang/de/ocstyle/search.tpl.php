	...
	<table class="table">
		<tr>
			...
			<td>
				<table class="table">
					<tr>
						<td><input type="checkbox" id="cachesize8" name="cachesize8" value="8" onclick="javascript:sync_options(this)" class="checkbox" {cachesize8checked} /> <label for="cachesize8">{t}nano{/t}</label></td>
