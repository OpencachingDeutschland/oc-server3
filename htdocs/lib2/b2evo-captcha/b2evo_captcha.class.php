...
class b2evo_captcha
{
    ...
    /**
          ...
          *
          **/
    public $counter_filename = 'b2evo_captcha_counter.txt';

    /**
          * Prefix of captcha image filenames
          *
          **/
    public $filename_prefix = 'b2evo_captcha_';
    ...
    /**
          ...
          *
          **/
    public $validchars = 'abcdefghjkmnpqrstuvwxyz23456789?@#$%&*ABCDEFGHJKLMNPQRSTUVWXYZ23456789?@#$%&*';
    ...
    //
        ...
        /**
          ...
          *
          **/
        public function b2evo_captcha($config, $secure=true)
        {

            // Test for GD-Library(-Version)
            $this->gd_version = $this->get_gd_version();
            if ($this->gd_version == 0) {
                die('There is no GD-Library-Support enabled. The b2evo captcha class cannot be used!');
            }
            if ($this->debug) {
            ...
            if (is_array($this->TTF_RANGE)) {
                ...
                if (count($this->TTF_RANGE) < 1) {
                    die('No Truetype fonts available for the CaptchaClass.');
                }
            } else {
                if ($this->debug) {
                ...
                if (!is_readable($this->TTF_folder.$this->TTF_RANGE)) {
                    die('No Truetypefont available for the b2evo captcha class.');
                }
            }
    ...
    //
        ...
        /**
          ...
          *
          **/
        public function get_b2evo_captcha()
        {
            $this->make_captcha();
    ...
    //
        ...
        /** @private **/
        public function make_captcha($private_key='')
        {
            if ($private_key=='') {
        ...
        /** @private **/
        public function makeWebsafeColors(&$image)
        {
            //$a = array();
            for ($r = 0; $r <= 255; $r += 51) {
                for ($g = 0; $g <= 255; $g += 51) {
        ...
        /** @private **/
        public function random_color($min, $max)
        {
        ...
        /** @private **/
        public function check_captcha($correct_hash, $attempt)
        {
