...
/*
$Id: nusoap.php,v 1.2 2008/03/09 10:16:13 oliver Exp $
...
* @version  $Id: nusoap.php,v 1.2 2008/03/09 10:16:13 oliver Exp $
* @access   public
*/
class nusoap_base {
	/**
	...
	function serialize_return() {
		...
		// returned value(s)
			...
			if($this->wsdl){
			    ...
			    $return_val = $this->wsdl->serializeRPCParameters($this->methodname,'output',isset($opParams)?$opParams:array());
			    $this->appendDebug($this->wsdl->getDebug());
			    $this->wsdl->clearDebug();
