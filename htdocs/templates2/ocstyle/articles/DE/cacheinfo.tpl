		...
		<p><b id="cachetype">Cacheart:</b> Es gibt mehrere M&ouml;glichkeiten, einen Cache zu gestalten:</p>
			<table  class="table">
				...
				<tr>
					...
					<td>Mathe-/Physikcache: Zur L&ouml;sung des Caches m&uuml;ssen eine oder mehrere Mathe- oder Physikaufgaben gel&ouml;st werden, die &uuml;ber das kleine Geocacher-1x1 hinaus gehen.</td>
				</tr>
				<tr><td class="spacer"><img src="/images/trans.gif" border="0" width="1" height="1" alt="" title=""></td></tr>
				<tr>
