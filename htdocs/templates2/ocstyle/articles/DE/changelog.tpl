...
<div class="content-txtbox-noshade changelog" style="padding-right: 25px;">
    ...
    <p>Opencaching Version 1.0 ging im August 2005 online. In den nachfolgenden Jahren wurde die Website stetig
        verbessert und zur Version 2 weiterentwickelt. Anfang 2011 wurde die Entwicklung vorübergehend eingestellt, bis
    ...
    <div class="changelog-changes">
        ...
        <ul>
            ...
            <li>Empfehlungsstern verschwindet <a href="http://redmine.opencaching.de/issues/1013"
                                                 target="_blank">#1013</a></li>
            <li>Versteckte Caches nach Cachetype im Profil... <a href="http://redmine.opencaching.de/issues/1001"
                                                                 target="_blank">#1001</a></li>
        ...
        <p>Geändert / verbessert:</p>
        <ul>
            <li>SessionCookie Daten werden nur noch über HTTPS übermittelt (<a href="https://github.com/rotzbua"
                                                                               target="_blank">rotzbua</a>)
            </li>
        ...
        <ul>
            ...
            <li>Die Karteneinstellung für die Einblendung der kleinen Übersichtskarte entfällt
                (Übersichtskarte ist nicht mehr verfügbar).
            </li>
        ...
        <ul>
            <li>Zusätzliche Wegpunkte in GPX-Dateien werden wieder korrekt gekennzeichnet
                (erscheinen z.B. in GSAK nicht mehr als separate Caches). [Bug von Version 9]
            </li>
        ...
        <ul>
            ...
            <li>Beim Ändern des Typs des neuesten Logs durch den Owner wird ggf. auch der Status des Caches mit
                angepasst. Der Typ älterer Statuslogs ist nicht mehr änderbar.
            </li>
        ...
        <ul>
            ...
            <li>Korrekturen in der <a href="doc/xml">XML-Schnittstelle</a>. Wer die Replikationsfunktion ab Version 1.4
                nutzt, sollte ein Komplettupdate einschieben.
            </li>
        </ul>
        <br/>
        ...
        <p>Neu:</p>
        <ul>
            <li><a href="http://wiki.opencaching.de/index.php/Das_Onlinelog#Der_Wartungszustand" target="_blank">Wartungszustände
                    loggen</a></li>
            <li>Koordinatenänderungen werden zwischen den Logs angezeigt. Der Cachebesitzer kann Altkoordinaten über
                eine Einstellung im Cachelisting schützen; die letzten drei Stellen erscheinen dann als ***.
            </li>
            <li>Wenn man Logs am nächsten Tag oder später ändert, erscheint unten im Log das letzte Änderungsdatum. Dies
                gilt nur für Änderungen ab Version 17.
            </li>
            <li>In Logbenachrichtigungen sind ggf. auch die Namen von Cachelisten enthalten, über die man den Cache
                beobachtet.
            </li>
        ...
        <p>Korrigiert (Bugfixes):</p>
        <ul>
            <li>Teile von Cachelistenbeschreibungen können nicht mehr über den Rahmen hinauslaufen. [Bug von Version
                13]
            </li>
        ...
        <p>Neu:</p>
        <ul>
            <li>Die Ergebnisse der <a href="search.php">Cachesuche</a> sind per Klick auf die Spaltenüberschriften
                sortierbar.
            </li>
            <li>Bei der Suchsortierung nach Versteckdatum wird dieses auch in den Ergebnissen angezeigt.</li>
            <li>In der <a href="ownerlogs.php">Loghistorie für die eigenen Caches</a> erscheint eine Statistik nach
                Logtyp.
            </li>
            <li>Alte Nachlogs können in der <a href="newlogs.php">Liste der neuen Logs</a> ausgeblendet werden; Liste
                nun wahlweise sortierbar nach Logdatum oder Einstelldatum.
            </li>
            <li>Anzeige von OConly-Markierungen (<img src="resource2/ocstyle/images/misc/15x15-oc.png">) in der Liste
                der neuen und der eigenen Logs.
            </li>
            <li>Es können nun auch erweiterte Unicode-Zeichen in Cachebeschreibungen, Logs, Profiltexten und
                Cachelistenbeschreibungen verwendet werden, zum Beispiel Smileys (&rarr; <a
                    href="http://forum.opencaching.de/index.php?topic=4342.0">weitere Informationen</a>).
            </li>
        ...
        <p>Geändert / verbessert:</p>
        <ul>
            <li>Die Liste der neuen Logs zeigt nun das Logdatum an statt des Datums, an dem das Log eingetragen wurde.
            </li>
            <li>Die Links zu navicache.com wurden aus der Cachebeschreibung entfernt; es können keine
                Navicache-Wegpunkte mehr eingetragen werden.
            </li>
            <li>Nach dem Bearbeiten von Bildern in einem Cachelisting geht es zurück zur Bearbeitungsseite statt zur
                Listinganzeige.
            </li>
            <li>Bei der Wahl des Statistikbildes wird zwischen aktuellen und sonstigen OC-Logos unterschieden.</li>
            <li>Deaktivierte Listings („momentan nicht verfügbar“) werden nun bereits nach 6 statt 12 Monaten
                automatisch archiviert, falls sie vom OC-Team deaktiviert wurden, oder falls der Cachebesitzer seit der
                Deaktivierung nicht mehr eingeloggt war. Ausgenommen davon sind Listings mit dem Attribut „Nur zu
                bestimmten Jahreszeiten suchbar“ und Listings mit Logs nach der Deaktivierung; hier bleibt es bei der
                12-Monatsfrist. Eine Änderung des Listings durch den Besitzer setzt den „Countdown“ wieder zurück. Der
                Besitzer kann die Archivierung jederzeit rückgängig machen.
            </li>
        ...
        <ul>
            ...
            <li>Anzeige des korrekten Symbols für Cachelistings, die vom Opencaching-Team gesperrt/versteckt wurden
                (<img src="resource2/ocstyle/images/cachestatus/16x16-locked-invisible.png">) [Bug von Version 6]
            </li>
            <li>Behandlung von HTML-Code in Cache-Kurzbeschreibungen korrigiert</li>
            <li>Bei der Umkreissuche nach „suchbaren“ Caches aus einem Cachelisting heraus werden deaktivierte Caches
                ausgeblendet. [Bug von Version 9]
            </li>
            <li>englische Datumsdarstellung in der Liste der neuen Caches korrigiert</li>
            <li>Zurücksetzen der Cachetypen <i>Drive-In</i> und <i>Mathe/Physik</i> sowie der Größen <i>nano</i> und <i>extrem
                    groß</i> durch Ocprop auf GC-Werte wird verhindert. [Bug von Version 6]
            </li>
            <li>Abschließende Korrekturen für den Start des HTTPS-Betriebs &rarr; <a href="https://www.opencaching.de">https://www.opencaching.de</a>;
                noch nicht stabil verfügbar für die OKAPI (&rarr; <a
                    href="https://github.com/opencaching/okapi/issues/343">weitere Informationen</a>)
            </li>
        ...
        <p>Neu:</p>
        <ul>
            <li>französische Übersetzung fertiggstellt; Relaunch von <a
                    href="http://www.opencaching.fr">Opencaching.fr</a></li>
        ...
        <p>Geändert / verbessert:</p>
        <ul>
            <li>bessere Präsentation der Seiten <a href="http://www.opencaching.it"
                                                   target="_blank">www.opencaching.it</a> und <a
                    href="http://www.opencachingspain.es" target="_blank">www.opencachingspain.es</a> (<a
                    href="http://redmine.opencaching.de/issues/816">#816</a>, <a
                    href="http://redmine.opencaching.de/issues/818">#818</a>)
            </li>
        ...
        <p>Korrigiert (Bugfixes):</p>
        <ul>
            <li>sinnvolle Textkonvertierung beim Umschalten zwischen Text- und HTML-Editor (<a
                    href="http://redmine.opencaching.de/issues/236">#236</a>)
            </li>
            <li>GPX- und TXT-Download liefert Cachebeschreibungen möglichst in der gewählten Sprache (<a
                    href="http://redmine.opencaching.de/issues/852">#852</a>)
            </li>
            <li>HTML-Code in Logbenachrichtigungen beseitigt</li>
            <li>&bdquo;An GPS-Gerät senden&ldquo; auf www.opencaching.it, www.opencachingspain.es und www.opencaching.fr
                repariert.
            </li>
        </ul>
        <br/>
        ...
        <ul>
            ...
            <li>Anzahl der Empfehlungen in der Übersicht der eigenen Caches hinzugefügt,
                Anzeige der Empfehlungen in verschiedenen Listenanzeigen angepasst
            </li>
        ...
        <ul>
            <li>Falschschreibung von Ortsnamen korrigiert
                (<a href="http://redmine.opencaching.de/issues/175">#175</a>)
            </li>
            ...
            <li>Korrektur des in seltenen Fällen falsch angezeigten Datums einer
                Empfehlung
                (<a href="http://redmine.opencaching.de/issues/713">#713</a>) [Bug von Version 9]
            </li>
            ...
            <li>Außerdem wurde viele weitere, kleinere Fehler behoben - vollständige Liste
                <a href="http://redmine.opencaching.de/versions/10">hier</a>.
            </li>
        </ul>
        <br/>
        ...
        <ul>
            ...
            <li>Um einen noch nicht veröffentlichten Cache zu veröffentlichen genügt es, unten im Listing „sofort
                veröffentlichen“ zu wählen.
        ...
        <p>Korrigiert (Bugfixes):</p>
        <ul>
            <li>zuverlässigeres Ausblenden von GC-Doppellistings bei der Cachesuche und auf der Karte [Bug von Version
                9]
            </li>
        ...
        <p>Neu:</p>
        <ul>
            <li>Link „mehr...“ in der Eventliste auf der Startseite, falls mehr als zehn Events oder Events in anderen
            ...
            <li>In den <a href="myprofile.php">Profildaten</a> kann man festlegen, dass beim Anschreiben anderer
                Benutzer standardmäßig die eigene Mailadresse mitgeschickt wird.
            </li>
        ...
        <ul>
            ...
            <li>zuletzt eingegebenes Logdatum wird nur noch 12 Stunden lang für neue Logs vorgeschlagen, danach wieder
                das aktuelle Datum
            </li>
        ...
        <ul>
            ...
            <li>Deaktivierte Events werden wie deaktivierte Caches nach einem Jahr automatisch archiviert. [Bug von
                Version 9]
            </li>
            <li>fehlende eigene Mailadresse beim Anschrieb anderer Benutzer ergänzt</li>
            <li>Fehler bei der Sprachumschaltung auf www.opencaching.it und www.opencachingspain.es behoben [Problem
                seit Version 10]
            </li>
            <li>kleinere Korrekturen an der OKAPI (&rarr; <a
                    href="https://code.google.com/p/opencaching-api/source/list">Changelog</a>)
            </li>
        </ul>
        <br/>
        ...
        <p>Neu:</p>
        <ul>
            <li>direkter Link auf ein bestimmtes Log per Rechtsklick auf das zugeh&ouml;rige Symbol und „Link
                kopieren“
            </li>
        ...
        <ul>
            ...
            <li>Link zum Listing auf der Listingseite mit http:// versehen, um es als Link auf Webseiten nutzbar zu
                machen
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>Erstellung des direkten Links zu einem Logeintrag nach dem Laden aller Logs korrigiert [Bug von Version
                10]
            </li>
        ...
        <p>Neu:</p>
        <ul>
            <li>Wenn mehr als 5 Logeinträge vorhanden sind und man zum Ende des Listings blättert, werden die übrigen
                Logs automatisch nachgeladen.
            </li>
        ...
        <ul>
            ...
            <li>Ausblendoption für Mehrfachlistings geändert in GC-Listings; dabei werden neben den Angaben des Owners
                zusätzliche, vom OC-Team eingepflegte GC-Wegpunkte berücksichtigt (auch auf der Karte).
            </li>
        ...
        <ul>
            ...
            <li>OConly-Caches werden in allen Cachelisten mit <img src="resource2/ocstyle/images/misc/15x15-oc.png"/>
                markiert.
            </li>
            <li>OConly-Hinweis in Benachrichtigungen über neue Caches; Benachrichtigung über neu markierte OConlys im
                Profil aktivierbar
            </li>
            <li>Informationen über <a href="http://wiki.opencaching.de/index.php/Schutzgebiete">Schutzgebiete</a> in
                GPX-, OKAPI- und <a href="http://wiki.opencaching.de/index.php/XML-Schnittstelle">XML-Interface</a>-Downloads
            </li>
            ...
            <li>laufende Auswertung und Vermeidung unzustellbarer Emails; siehe auch Version 5 / unzustellbare Emails
            </li>
        ...
        <ul>
            ...
            <li>übersichtlicheres Startseiten-Menü, aufgeteilt in &bdquo;Aktuelles&ldquo; und
                &bdquo;Opencaching&ldquo;
            </li>
            <li>Anzeige eigener unveröffentlichter Caches auf der Karte (kann eine Stunde dauern, bis sie erscheinen)
            </li>
            <li>deutlichere Kennzeichnung neuer Caches in Suchergebnislisten; Neu-Zeitraum von 7 auf 14 Tage erweitert
            </li>
            ...
            <li>Ausblenden ungültiger Dutch-Grid-Koordinaten bei &bdquo;andere Koordinatensysteme&ldquo; im
                Cachelisting
            </li>
            ...
            <li>Status-Logs (siehe Version 8) werden auch durch <a href="http://wiki.opencaching.de/index.php/Ocprop">Ocprop</a>
                und beim Deaktivieren von Benutzerkonten erzeugt
            </li>
        ...
        <ul>
            ...
            <li>Versionsinkonsistenz in GPX-Dateien behoben durch vollständige Umstellung auf Groundspeak-Version
                1.0.1
            </li>
        ...
        <p>Neu:</p>
        <ul>
            <li>Der Cachestatus kann (nur noch) per Log geändert werden. Dazu gibt es die neuen Logtypen <em>momentan
                    nicht verfügbar</em>, <em>archiviert</em>, <em>gesperrt</em> und <em>kann gesucht werden</em>. Der
                gleiche Status kann auch mehrmals geloggt werden, z.B. um zu signalieren dass mit dem Cache alles ok
                ist. Der Typ alter Logs kann nachträglich geändert werden.
            </li>
            ...
            <li><a href="http://wiki.opencaching.de/index.php/Reverse_%28%E2%80%9ELocationless%E2%80%9C%29_Caches">Safari-Caches</a>
            </li>
            ...
            <li>Link &bdquo;geloggte Caches&ldquo; im Benutzerprofil; Auflistung der eigenen Logs sortiert nach
                Logdatum
            </li>
            <li>Zahl der aktiven Caches im Benutzerprofil, + Link &bdquo;anzeigen&ldquo;</li>
            <li>Suchergebnisse sind nach Datum des letzten eigenen Logs sortierbar; in der Suchergebnisliste erscheinen
                dann rechts nur die eigenen Logs
            </li>
            <li>Kartenfilter-Einstellungen sind nun permanent speicherbar</li>
            <li>OC-Supportmitarbeiter können ihr Logs als &bdquo;OC-Team-Log&ldquo; (<img
                    src="resource2/ocstyle/images/oclogo/oc-team-comment.png"/>) markieren.
            </li>
            <li>neuer Menüpunkt <a href="okapi/apps/">API-Anwendungen</a> im Benutzerprofil, zur Kontrolle von <a
                    href="okapi">OKAPI</a>-Anwendungsrechten
            </li>
            <li><a href="http://wiki.opencaching.de/index.php/XML-Schnittstelle">XML-Interface</a>: zusätzliche
                Wegpunkte, Loguhrzeit, OC-Team-Log-Flag und Vorschaubild-Flag werden mitgeliefert
            </li>
        ...
        <ul>
            ...
            <li>Layout/Design des Cachelisting-Kopfes überarbeitet, u.a. mit Anzeige der Kurz-URL, übersichtlicheren
                Druckbuttons und schönerer Wegstreckenanzeige
            </li>
            <li>Abgelaufene Events werden auf der Karte grau dargestellt, wie inaktive Caches.</li>
            <li>Zurücksetzen-Buttons aus allen Dialogen rausgeworfen; Ändern-Buttons in &bdquo;Speichern&ldquo;
                umbenannt
            </li>
            ...
            <li>(Nicht-)Ignorieren von Caches wirkt sich sofort auf die Kartendarstellung aus, statt wie bisher
                zeitverzögert.
            </li>
            ...
            <li>Unterscheidung zwischen &bdquo;möchte teilnehmen&ldquo; und &bdquo;teilgenommen&ldquo; in
        ...
        <p>Korrigiert (Bugfixes):</p>
        <ul>
            <li>Event-Log-Icons (<img src="resource2/ocstyle/images/log/16x16-will_attend.png"/> <img
                    src="resource2/ocstyle/images/log/16x16-attended.png"/>) in Suchlisten
            </li>
            ...
            <li>Persönliche Notizen verändern nicht mehr das Listing-Änderungsdatum; Datum der betroffenen Caches
                korrigiert. [Bug von Version 6]
            </li>
            <li>&bdquo;Cache verstecken&ldquo; führt nicht angemeldete User wieder auf die Loginseite. [Bug von Version
                5]
            </li>
            <li>XML-Interface-DTDs korrigiert</li>
            <li>diverse OKAPI-Korrekturen</li>
            <li><a href="http://wiki.opencaching.de/index.php/Ocprop">Ocprop</a>-Problem beim Abgleich von Logs behoben
                [entstanden kurz nach Freigabe von Version 7]
            </li>
        </ul>
        <br/>
        ...
        <ul>
            ...
            <li>Datenlizenz-Anzeige links auf jeder Seite; Datenlizenz-Disclaimer wird in GPX-Dateien, TXT-Dateien und
                via <a href="http://wiki.opencaching.de/index.php/XML-Schnittstelle">XML-Schnittstelle</a> mitgeliefert.
            </li>
            ...
            <li><a href="http://wiki.opencaching.de/index.php/Listingvandalismus">Listingvandalismus</a> kann vom
                Opencaching-Supportteam rückgängig gemacht werden
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>Änderungen von zusätzlichen Wegpunkten und Bildern werden beim Änderungsdatum des Listings
                berücksichtigt.
            </li>
            <li>Cachesuche funktionierte manchmal unmittelbar nach dem Ausloggen nicht</li>
            <li>korrekte Typbezeichung zusätzlicher Wegpunkte (z.B. &bdquo;Parkplatz&ldquo;) in GPX-Dateien [Bug von
                Version 4]
            </li>
            <li>Beim Löschen von Logs werden auch die Bilder mitgelöscht; bisher blieben sie irgendwo im System
                stehen.
            </li>
            <li>Problem mit <a href="http://wiki.opencaching.de/index.php/Ocprop">Ocprop</a>-Logduplikate behoben
                [entstanden durch Version 5]
            </li>
            <li>Logeditor auf der englischen, italienischen und spanischen Seite in korrekter Sprache</li>
            <li>Übersetzung von Ländernamen (in denen die Caches liegen) auf der englischen, italienischen und
                spanischen Seite
            </li>
        </ul>
        <br/>
        ...
        <ul>
            <li>Markierung von eigenen, gefundenen, nicht gefundenen und <a
                    href="http://wiki.opencaching.de/index.php/OConly" target="_blank">OConly</a>-Caches
            </li>
            <li><a href="map2.php?mode=fullscreen">Vollbildkarte</a> mit ausklappbaren Filtereinstellungen</li>
            <li><a href="http://wiki.opencaching.de/index.php/Zusätzliche_Wegpunkte" target="_blank">zusätzliche
                    Wegpunkte</a> des gewählten Caches werden angezeigt
            </li>
            ...
            <li>pro Cache ist ein <a href="http://wiki.opencaching.de/index.php?title=Vorschaubilder" target="_blank">Vorschaubild</a>
                einstellbar, das bei Auswahl des Caches auf der Karte erscheint
            </li>
            ...
            <li>schönere Popup-Fenster mit OConly-Icons, Schwierigkeits- und Geländesymbolen und größeren
                Cachesymbolen
            </li>
            ...
            <li>zusätzliches Katenmaterial von <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">OpenCycleMap</a>
                und <a href="http://www.mapquest.de/" target="_blank">MapQuest</a></li>
            <li>interne Umstellung von Google Maps Version 2 auf Version 3; <span class="redtext">im Microsoft Internet Explorer recht träge, Verwendung eines anderen Browsers wird empfohlen</span>
            </li>
        </ul>

        <p>Sonstige Neuerungen und Änderungen:</p>
        <ul>
            <li>Auf den meisten Seiten gibt es nun rechts oben einen Hilfe-Knopf, der auf eine passende Seite im <a
                    href="http://wiki.opencaching.de/" target="_blank">Opencaching-Wiki</a> verweist.
            </li>
            <li>Logbild-Galerien auf der Startseite, der neuen <a href="newlogpics.php">Galerieseite</a>, in den
                Cachelistings (erreichbar per Link &bdquo;Logbilder&ldquo;) und in den Benutzerprofilen. Die
                Profil-Bildgalerien sind per <a href="mydetails.php">Profileinstellungen</a> abschaltbar.
            </li>
            ...
            <li>Bei unzustellbaren Emails erhalten Benutzer ggf. eine Aufforderung, ihre Mailadresse zu ändern oder zu
                bestätigen.
            </li>
            <li>Inaktive Caches werden in der Beobachtungsliste <s>durchgestrichen</s>, wie bereits in der
                Ignorierliste.
            </li>
        ...
        <ul>
            ...
            <li><a href="http://wiki.opencaching.de/index.php/Wegpunkte#Interne.2C_zus.C3.A4tzliche_Wegpunkte"
                   target="_blank">Zusätzliche Wegpunkte</a> sind in <a
                    href="http://wiki.opencaching.de/index.php/Wie_erhalte_ich_eine_GPX-Datei%3F" target="_blank">GPX-Dateien</a>
                enthalten und werden ans GPS-Gerät gesendet
            </li>
            <li>Bilder (inkl. Spoilerbildern) aus Cachelistings werden in GPX-Dateien eingebettet. Um sie unterwegs
                sehen zu können, ist eine Internetverbindung nötig.
            </li>
        ...
        <ul>
            ...
            <li>Die <a href="map2.php">Karte</a> zeigt jetzt bis zu 600 statt 180 Cachesymbole an (MS Internet Explorer:
                bis zu 200).</a></li>
            ...
            <li><a href="articles.php?page=team">Team-</a> und <a href="articles.php?page=donations">Spendenseite</a>
                aktualisiert</a></li>
            <li><a href="articles.php?page=dsb">Datenschutzbelehrung</a> aktualisiert; Verbesserungen beim
                Datenschutz</a></li>
        ...
        <p>Neu:</p>
        <ul>
            <li><a href="./articles.php?page=cacheinfo#difficulty">Schwierigkeitsgrade</a> erklärt, inklusive Tooltip
                und Link in den Cachelistings
            </li>
        ...
        <ul>
            ...
            <li><a href="./doc/xml/">XML-Interface-Doku</a> und <a
                    href="https://github.com/OpencachingDeutschland/oc-server3/blob/master/doc/license.txt">Quellcodelizenz</a>
                aktualisiert
            </li>
            <li><a href="./articles.php?page=team">Teamliste</a> aktualisiert</li>
            ...
            <li>Platz für neue Caches: Beschränkung auf 65535 Listings (OCFFFF, inkl. archivierter Caches) aufgehoben
            </li>
            <li>spanische und italienische Übersetzung vervollständigt</li>
            <li>inaktive Caches auch auf der <a href="./newcachesrest.php">Alle-außer-Deutschland-Seite</a> ausgeblendet
            </li>
        ...
        <ul>
            ...
            <li>Empfehlungen gehen beim mehrfachen Loggen eines Caches &ndash; z.B. Fund + Hinweis &ndash; nicht mehr
                verloren.
            </li>
            <li>Empfehlungen gehen beim Löschen eines von mehreren Logs des gleichen Benutzers oder beim Bearbeiten von
                einem der Logs nicht mehr verloren.
            </li>
            <li>Mehrfachlogs eines Benutzers zählen bei der Bewertungsübersicht auf der Startseite nur noch einmal.</li>
            <li><a href="doc/xml/">Das XML-Interface</a> schneidet im Standardzeichensatz keine Daten mehr bei
                unbekannten Zeichen ab.
            </li>
            ...
            <li>wirkungslose Spoileroption beim Hochladen von Logbildern entfernt [&rarr; wieder eingebaut in Version
                5]
            </li>
        </ul>
        <br/>
        ...
        <p>Neu:</p>
        <ul>
            <li>Kurzadressen für Direktzugriff auf Cachelistings, z.B. <a href="https://www.opencaching.de/OCD93B">http://opencaching.de/OCD93B</a>
            </li>
            <li>Anzeige &bdquo;Du hast dieses Event besucht&ldquo; in Karten-Popup-Fenstern
            <li>englische Übersetzung der Seiten <a href="./articles.php?page=geocaching">Über Geocaching</a>, <a
                    href="./articles.php?page=cacheinfo">Cachebeschreibung</a>, <a href="./articles.php?page=impressum">Impressum
                    &amp; Nutzungsbedingungen</a>, <a href="./articles.php?page=dsb">Datenschutzbelehrung</a>, <a
                    href="./articles.php?page=donations">Spenden</a>, <a href="./articles.php?page=contact">Kontakt</a>
                und <a href="./articles.php?page=team">Teamliste</a> (umschalten auf englischsprachige Seite oben mit
        ...
        <ul>
            ...
            <li>Umstellung <a href="./articles.php?page=impressum">Impressum</a> und <a
                    href="./articles.php?page=donations">Spendenseite</a></li>
            <li>neue <a href="./articles.php?page=team">Teamliste</a></li>
            <li>Anzeige neue Caches auf der <a href="./index.php">Startseite</a> nach Veröffentlichungs- statt
                Versteckdatum, auf der <a href="./newcaches.php">Neue-Caches-Seite</a> nach Veröffentlichungs- statt
                Einstelldatum des Listings
            </li>
            <li>deaktivierte und archivierte Caches in der Liste der neuen Caches ausgeblendet</li>
            <li>keine abgeschnittenen GC-Wegpunkte mehr bei Copy&amp;Paste mit führenden Leerzeichen (häufiges
                Problem)
            </li>
            <li>eindeutige Bezeichnungen für Entfernungen und Wegstrecken</li>
            <li>Listinganzeige: &bdquo;not found&ldquo; &rarr; &bdquo;nicht gefunden&ldquo;, &bdquo;Maps&ldquo; &rarr;
                &bdquo;Karten&ldquo;
            </li>
            <li>Layoutangleichung von <a href="./search.php">Suchseite</a>, <a href="http://www.blog.opencaching.de">Blog-/Infoseite</a>
                und den übrigen Seiten
            </li>
            <li>Entfernungsangabe &bdquo;0.0 km&ldquo; in Suchlisten in ausgeloggtem Zustand ausgeblendet (keine
                Homekoordinaten verfügbar)
            </li>
        </ul>
        <p>Korrigiert (Bugfixes):</p>
        <ul>
            ...
            <li>Anzeige des Cachetyp-Icons für unveröffentlichte Caches (bei <a href="./myhome.php">Benutzerprofil</a>
                &rarr; Alle anzeigen)
            </li>
            <li>Link &bdquo;Geokrety-Verlauf&ldquo; und Empfehlungszahl im Cachelisting werden bei großer Schrift nicht
                mehr abgeschnitten
            </li>
