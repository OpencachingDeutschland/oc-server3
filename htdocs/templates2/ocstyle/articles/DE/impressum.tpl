...
<div class="content-txtbox-noshade" style="padding-right: 25px;">
    ...
    <p>
        Laut &sect;10 der Vereinssatzung vom 30.05.2012 ist der Vorsitzende alleine vertretungsberechtigt, die zwei
        weiteren Mitglieder des gesch&auml;ftsf&uuml;hrenden
        Vorstandes gemeinsam vertretungsberechtigt.<br>
        Mit Eintragung der geänderten Satzung vom 28.05.2017 ist jeder geschäftsführende Vorstand einzeln
    ...
    <p>
        ...
        jeweiligen Autoren. &Auml;nderungen der Nutzungsbedingungen werden f&uuml;r eine
        angemessene Zeit auf der Startseite sowie im Forum bekannt gegeben. Die
        &Auml;nderungen werden dabei hervorgehoben dargestellt. Eine weitere Nutzung des
        Internetangebotes wird als Einverst&auml;ndnis mit den ge&auml;nderten
        Nutzungsbedingungen verstanden. Sollte eine der hier genannten rechtlichen
        Bestimmungen gegen geltendes Recht versto&szlig;en bzw. durch geltendes Recht
        ihre G&uuml;ltigkeit verlieren, sind alle anderen Bestimmungen davon nicht betroffen.
        Dies gilt auch, wenn der Verlust der G&uuml;ltigkeit erst im Laufe der Nutzung
        entsteht.
    </p>
...
<div class="content-txtbox-noshade" style="padding-right: 25px;">
    <p>Aufgrund einer Entscheidung der Mitgliederversammlung vom 09.02.2019 wurden die Nutzungsbedingungen überarbeitet.
       Sie sind nun unter
        <a href="http://www.opencaching.de/articles.php?page=terms">http://www.opencaching.de/articles.php?page=terms
        </a>
       zu finden
    </p>
</div>
...
<div class="content-txtbox-noshade" style="padding-right: 25px;">
    <p>
        <a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/3.0/de/">
            <img alt="Creative Commons Lizenzvertrag"
                 style="border: 0; padding-right: 15px; padding-bottom: 15px; float: left;"
                 src="https://i.creativecommons.org/l/by-nc-nd/3.0/de/88x31.png"/></a>
    ...
    <p>
        zu verwenden, wobei das Datum sich auf den Abrufzeitpunkt von www.opencaching.de bezieht. Bei Fotos und Logeintr&auml;gen
        kann vom Datum abgesehen werden.
        <br/>
        <br/>
        Weitere Erläuterungen zur Datenlizenz gibt es im
        <a href="http://wiki.opencaching.de/index.php/Datenlizenz" target="_blank">Wiki</a>
        .
    </p>
