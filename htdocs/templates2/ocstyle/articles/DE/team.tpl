...
<div class="content2-pagetitle">
    <img src="resource2/{$opt.template.style}/images/misc/32x32-globi.png" style="margin-right: 10px;" width="32"
         height="32" alt=""/>Unser Team
</div>
<div class="content-txtbox-noshade" style="padding-right: 25px;">
    ...
    <p>
        An dieser Stelle m&ouml;chten wir uns auch bei allen Benutzern und ungenannten Helfern bedanken, die immer
        wieder mit neuen Vorschl&auml;gen
