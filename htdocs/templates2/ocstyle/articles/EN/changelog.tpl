...
<div class="content-txtbox-noshade changelog" style="padding-right: 25px;">
    ...
    <p>Opencaching.de Version 1.0 went online in August 2005 und was steadily enhanced in the following years, switching
        to Version 2. In the beginning of 2011, development was halted, until the new Opencaching Deutschland
        association restarted it in July 2012 at Version&nbsp;3.0.</p>

    <p>This page lists all changes since version 3.0. Some minor changes have been omitted here. New Features may be
        relased before the final relase date.</p>
    <br/>
    ...
    <div class="changelog-changes">
        ...
        <ul>
            ...
            <li>When the owner changes the type of the latest log, the cache status will be adjusted (depending on the
                old/new log type). The type of older status logs can no longer be changed.
            </li>
        ...
        <ul>
            ...
            <li><a href="doc/xml">XML interface fixes</a>. If you were using the replication feature of version 1.4, you
                should import a complete dump.
            </li>
        </ul>
        <br/>
        ...
        <p>New:</p>
        <ul>
            <li>With every log, the maintenance state of the cache and the cache description can be supplied. If
                "geocache needs maintenance" or "description is outdated" is chosen, this is indicated by corresponding
                symbols in the upper right area of the listing. The owner or any other user may reset these marks by
                another log, if he thinks that the geocache / the description is ok (now). The marks should be set only
                if there are substancial problems with the cache or the description.
            </li>
            <li>Coordinate changes are displayed inbetween logs. The cache owner may protect old coordinates by a
                listing setting; then the last three digits will be replaced by ***.
            </li>
            <li>If logs entries are edited on the day after or later, the last modification date is displayed at the
                bottom of the log. This works only for changes since release 17.
            </li>
        ...
        <ul>
            ...
            <li>Old late logs can be hidden in the <a href="newlogs.php">list of new logs</a>; list now is sortable by
                either log date or log submit date.
            </li>
            <li>OConly marks (<img src="resource2/ocstyle/images/misc/15x15-oc.png">) are shown in the lists of new logs
                and of own logs.
            </li>
            <li>Special Unicode symbols (character codes &gt; 65535, e.g. smileys) can be entered in cache descriptions,
                logs, user profile texts and cache list descriptions.
            </li>
        ...
        <ul>
            ...
            <li>Removed the links to navicache.com from cache descriptions; Navicache waypoints can no longer be
                entered.
            </li>
            ...
            <li>Disabled listings ("temporarily not available") now are archived automatically after 6 instead of 12
                months, if they have been disabled by OC admins or if the owner has not been logged in since disabling
                the cache. Caches with attribute "Only available during specified seasons" are excempt from this rule,
                as well as caches with new logs after disabling; the 12 months period applies here. Any listing
                modifications by the owner reset the archiving "countdown". The owner may arbitrarily change the state
                back to "temporarily not available".
            </li>
        ...
        <ul>
            ...
            <li>Show the correct symbol for cache listings which have been locked/hidden by the Opencaching team (<img
                    src="resource2/ocstyle/images/cachestatus/16x16-locked-invisible.png">) [bug of release 6]
            </li>
            <li>fixed handling of HTML code in cache short-descriptions</li>
            <li>When chosing "search geocaches nearby: searchable" in a cache listing, disabled caches will be hidden.
                [bug of release 9]
            </li>
            <li>fixed english date layout in the list of new caches</li>
            <li>prevented resetting of the chache types <i>Drive-in</i> and <i>Maths/Physics</i> as well as the sizes
                <i>nano</i> and <i>extremely large</i> by Ocprop to GC values. [bug of release 6]
            </li>
            <li>final adjustments for the start of HTTPS &rarr; <a href="https://www.opencaching.de">https://www.opencaching.de</a>;
                not yet stable implemented for OKAPI (&rarr; <a href="https://github.com/opencaching/okapi/issues/343">more
                    info</a>)
            </li>
        ...
        <p>Changed / improved:</p>
        <ul>
            <li>better presentation of <a href="http://www.opencaching.it" target="_blank">www.opencaching.it</a> and <a
        ...
        <p>Fixed:</p>
        <ul>
            <li>reasonable text conversions when switching between text and HTML editor (<a
                    href="http://redmine.opencaching.de/issues/236">#236</a>)
            </li>
            <li>GPX and TXT download will return cache descriptions preferably in the selected language (<a
                    href="http://redmine.opencaching.de/issues/852">#852</a>)
            </li>
            <li>removed HTML code from log notifications</li>
            <li>Fixed &bdquo;Send to GPS devices&ldquo; at www.opencaching.it, www.opencachingspain.es and
                www.opencaching.fr.
            </li>
        </ul>
        <br/>
        ...
        <ul>
            ...
            <li>Corrected the (in rare cases) wrong date for recommendations
                (<a href="http://redmine.opencaching.de/issues/713">#713</a>) [bug of release 9]
            </li>
            ...
            <li>Furthermore, many smaller bugs were fixed, see <a
                    href="http://redmine.opencaching.de/versions/10">here</a>
                for a complete list.
            </li>
        </ul>
        <br/>
        ...
        <ul>
            ...
            <li>To publish an unplished cache, only the "publish now" option at the bottom of the listing needs to be
                changed.
            </li>
        ...
        <p>New:</p>
        <ul>
            <li>"more..." link in the start page event list, if there are more than ten events or events in other
                countries
            </li>
            ...
            <li>new <a href="myprofile.php">user profile setting</a> to include the own e-mail address by default when
        ...
        <ul>
            ...
            <li>The last entered log date will be used as default for only 12 hours; then the current date is proposed
                for new logs.
            </li>
        ...
        <ul>
            ...
            <li>some OKAPI fixes (&rarr; <a href="https://code.google.com/p/opencaching-api/source/list">changelog</a>)
            </li>
        </ul>
        <br/>
        ...
        <p>New:</p>
        <ul>
            <li>get direct link to a specific log entry by right-clicking on its symbol and choosing "copy hyperlink"
            </li>
        ...
        <p>New:</p>
        <ul>
            <li>automatically load rest of log entries, when scrolling to the end of a cache page and more than 5 logs
                are present
            </li>
        ...
        <ul>
            ...
            <li>changed hide-crosslistings option in hide GC listings; does use additional waypoints maintained by the
                Opencaching team (also on the map)
            </li>
        ...
        <ul>
            ...
            <li>OConly caches are marked with <img src="resource2/ocstyle/images/misc/15x15-oc.png"/> in cache lists
            </li>
            <li>OConly tag in new cache notifications; notifications about newly tagged OConlies can be enabled in user
                profile
            </li>
            ...
            <li>"Temporarily unavailable" geocaches are automatically archived after one year, event caches after five
                weeks.
            </li>
        ...
        <p>New:</p>
        <ul>
            <li>The geocache listing status can now (only) be changed by logging the new state. New log types <em>temporarily
                    unavailable</em>, <em>archived</em>, <em>locked </em> und <em>ready for search</em> have been added.
                Unchanged states may be logged, too, e.g. to confirm that the cache is still searchable. The type of old
                logs can be changed afterwards.
            </li>
            ...
            <li>search results are sortable by date of own log; only the own logs are shown then in the right column of
                the search results list
            </li>
            <li>map filter settings now can be saved permanently</li>
            <li>OC support team members can mark thir logs as "OC team log" (<img
                    src="resource2/ocstyle/images/oclogo/oc-team-comment.png"/>)
            </li>
            <li>added additional waypoints, log time, OC team log flag and preview picture flag to the "XML interface"
            </li>
            <li>additional user profile menu option <a href="okapi/apps/">API applications</a>, to control <a
                    href="okapi">OKAPI</a> app access rights
            </li>
        ...
        <ul>
            ...
            <li>When deleting logs, the original log text and the listing address are added to the notification email.
            </li>
            <li>strike-trough of inactive caches in search result lists</li>
            <li>redesign of listing header, e.g. display of short URLs, dropdown list for print view options and neater
            ...
            <li>updated <a href="articles.php?page=verein">Opencaching Deutschland e.V.</a> page and membership
        ...
        <ul>
            <li>event log icons (<img src="resource2/ocstyle/images/log/16x16-will_attend.png"/> <img
                    src="resource2/ocstyle/images/log/16x16-attended.png"/>) in search result lists
            </li>
            ...
            <li>personal notes will not change the listing modification date; fixed date of the affected listings [bug
                of release 6]
            </li>
        ...
        <ul>
            ...
            <li>Data license is displayed on the left hand of all pages and is deliverd through GPX and TXT download and
                "XML interface".
            </li>
        ...
        <ul>
            ...
            <li>reduced news and forum post display on the start page to headlines-only; double number of display
                posts
            </li>
        ...
        <ul>
            <li>Own, found, not found and <a href="http://wiki.opencaching.de/index.php/OConly"
                                             target="_blank">OConly</a> caches are marked
            </li>
            ...
            <li>Cache selection / filtering improvements:
                <ul>
                    ...
                    <li>preselection of the most relevant attributes like at the <a href="search.php">search pache</a>
                    </li>
            ...
            <li>additional maps from <a href="http://www.thunderforest.com/opencyclemap/"
                                        target="_blank">OpenCycleMap</a> and <a href="http://www.mapquest.com/"
                                                                                target="_blank">MapQuest</a></li>
            <li>internal change from Google Maps Version 2 to Version 3; <span class="redtext">somewhat sluggish in Microsoft Internet Explorer, we recommend to use another browser</span>
            </li>
        </ul>

        <p>Other new features and changes:</p>
        <ul>
            <li>Log picture galleries on the start page, the new <a href="newlogpics.php">gallery page</a>, in cache
                listings (via link "log pictures") and in user profiles. The profile galleries can be disabled via <a
                    href="mydetails.php">profile settings.</a></li>
            ...
            <li>After emails could not be delivered, users may be prompted to confirm or change their email address.
            </li>
            <li>Inactive caches are <s>striked out</s> in the <a href="mywatches.php">watch list</a> like in the ignore
                list.
            </li>
        ...
        <ul>
            ...
            <li>Picturs (including spoilers) from cache listings are embedded in GPX files. You will need internet
                connection to view them in field.
            </li>
        ...
        <ul>
            ...
            <li>The <a href="map2.php">map</a> will now show up to 600 instead of 180 cache symbols (MS Internet
                Explorer: up to 200).</a></li>
            ...
            <li>updated <a href="articles.php?page=team">team</a> and <a
                    href="articles.php?page=donations">donations</a> page</a></li>
        ...
        <p>New:</p>
        <ul>
            <li><a href="./articles.php?page=cacheinfo#difficulty">Difficulty ratings</a> explained, including tooltips
                and links within the cache listings
            </li>
        ...
        <ul>
            ...
            <li>updated <a href="./doc/xml/">XML Interface Documentation</a> (German) and <a
                    href="https://github.com/OpencachingDeutschland/oc-server3/blob/master/doc/license.txt">Source code
                    license</a></li>
            <li>updated <a href="./articles.php?page=team">Team members list</a></li>
        ...
        <ul>
            ...
            <li>Recommendations are no longer lost when deleting one of multiple logs of the same user, or when editing
                one of them.
            </li>
        ...
        <p>New:</p>
        <ul>
            <li>URL shortener for direct cache listing access, e.g. <a href="https://www.opencaching.de/OCD93B">https://www.opencaching.de/OCD93B</a>
            </li>
            <li>englisch translation of <a href="./articles.php?page=geocaching">About Geocaching</a>, <a
                    href="./articles.php?page=cacheinfo">Cache descriptions</a>, <a
                    href="./articles.php?page=impressum">Legal information</a>, <a href="./articles.php?page=dsb">Privacy
                    statement</a>, <a href="./articles.php?page=donations">Donations</a>, <a
                    href="./articles.php?page=contact">Contact</a> and <a href="./articles.php?page=team">Team members'
                    list</a> pages; team list, legal information and donations pages have been updated
            </li>
        ...
        <ul>
            ...
            <li>display of new caches at <a href="./index.php">start page</a> by publishing instead of hiding date, and
                at <a href="./newcaches.php">New caches</a> page by publishing instead of listing creation date
            </li>
            <li>inactive caches are hidden in new caches lists</li>
            <li>GC waypoints will be no longer truncated when copy-and-pasted with leading spaces (frequent problem)
            </li>
            <li>layout adjustment of <a href="./search.php">search page</a> and <a
                    href="http://www.blog.opencaching.de">blog/info page</a></li>
        ...
        <ul>
            ...
            <li>display of cache type icon for unpublished caches at <a href="./myhome.php">user profile</a> &rarr; Show
                all
            </li>
            <li>link "Geokrety history" and recommendation count in cache listings will not be cropped when using big
                fonts
            </li>
