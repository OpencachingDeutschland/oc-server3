...
***************************************************************************}
	...
	<br />
	 ...
	 <ul>
	   ...
	   <li>fix: correct default country for new caches, fixed &bdquo;Belgium/Afghanistan problem&ldquo;</li>
	   ...
	   <li>fix: link &bdquo;Geokrety history&ldquo; and recommendation count in cache listings will not be cropped when using big fonts</li>
