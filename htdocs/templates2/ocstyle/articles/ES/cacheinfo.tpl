  ...
  <table>
    <tbody>
      <tr>
        ...
        <td>Cache Tradicional: Las coordenadas son la ubicación de la cache que está disponible como una caja de tupperware encuentralá y abrir el contenedor hay obsequios, etc.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Drive-In: como un cache normal, pero hay muy cerca de un parking. Para encontrar el cache no se requerire ningún equipo especial.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Multi-Cache: Las coordenadas dadas no representan la ubicación de la cache, pero si un posible punto de partida para encontrar el caché. Esto puede lograrse mediante la resolución de problemas o rompecabezas, sino también por el encontrar estaciones o puntos intermedios. </td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Puzzle Cache: Un puzzle  puede ser cualquier cache (normal, varios, etc virtual). La solución del puzzle te permitira encontrar el contenedor.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Matemática-/Físicache: Para resolver el cache, tendra uno o más problemas de matemáticas o la física que ser resueltos.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td> Cache Móvil: Este tipo de cache está escondido, y a lo largo de su vida tendra varias nuevas ubicaciones e incluso tareas. Las nuevas coordenadas y la nueva tarea se publicará en la entrada del registro.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Cache Virtual: El objetivo no es una caja de Tupperware y no hay ningún libro de registro. Dependiendo de la tarea, es necesario responder a una pregunta que propondra el propietario del cache o para hacer una foto para demostrar que ha estado en ese  sitio.</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Webcam Cache:  A menudo se encuentra como la cámara web en las coordenadas y donde tendrá que tomarse una  imagen de sí mismo. La imagen se añade a la entrada del registro. No hay contenedores o un libro de registro.</td>
      </tr>
      <tr>
        ...
        <td>Evento: Reunión de geobuscadores..</td>
      </tr>
      <tr>
        <td><img src="http://www.opencaching.de/images/trans.gif" border="0" width="1" height="1" alt="" title="" /></td>
      </tr>
      <tr>
        ...
        <td>Cache de tipo desconocido: Todo lo que no encaja en los tipos de caché de otros.</td>
      </tr>
    </tbody>
  </table>
