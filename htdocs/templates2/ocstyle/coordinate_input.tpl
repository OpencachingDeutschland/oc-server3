<table class="table">
  <tr>
    ...
    <td>
      <input type="text" name="lat_deg" maxlength="2" value="{$lat_deg}" class="input30" {if $disabled}disabled=""{/if} /> &deg;
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <input type="text" name="lon_deg" maxlength="3" value="{$lon_deg}" class="input30" {if $disabled}disabled=""{/if} /> &deg;
    </td>
    <td>
