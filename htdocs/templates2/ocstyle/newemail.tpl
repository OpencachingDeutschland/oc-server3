...
<div class="content2-pagetitle">
	<img src="resource2/{$opt.template.style}/images/profile/32x32-profile.png" style="align: left; margin-right: 10px;" width="32" height="32" alt="{t}Change E-Mail address{/t}" />
...
<form action="newemail.php" method="post" style="display: inline;">
	...
	<table class="table">
		...
		<tr>
			<td>&nbsp;</td>
			<td>
        <input type="submit" value="{t}Request{/t}" class="formbuttons" />
			</td>
		</tr>
	...
	<table class="table">
		...
		<tr>
			<td class="header-small" colspan="2">
				...
				<input type="submit" value="{t}Change{/t}" class="formbuttons" />
			</td>
		</tr>
	</table>
</form>