                ...
                <table class="table" style="width:100%">
                    ...
                    {foreach from=$queries item=queriesItem}
                        ...
                        <tr>
                            ...
                            <td class="{$listcolor}"><nobr><span style="float: right;">[<a href="search.php?queryid={$queriesItem.id}&showresult=0">{t}edit{/t}</a>] [<a href="javascript:if(confirm('{t escape=js}Do you really want to delete the saved search?{/t}'))location.href='query.php?queryid={$queriesItem.id}&action=delete'">{t}delete{/t}</a>]</span></nobr></td>
                        </tr>
                    {foreachelse}
