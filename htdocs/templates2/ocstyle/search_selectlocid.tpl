...
<div class="content2-pagetitle"><img src="resource2/ocstyle/images/cacheicon/traditional.gif" style="margin-right: 10px;" width="32" height="32" alt="" />{t}Selection of city{/t} - {t 1=$resultscount}Total of %1 cities matched{/t}</div>
