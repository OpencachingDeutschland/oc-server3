    ...
    <div class="">
        ...
        <div class="content2-container-2col-left" id="cache_name_block">
            ...
            <div style="margin-left: 50px;">
                <p>{t}by{/t}&nbsp;<b><a href="viewprofile.php?userid={$cache.userid}">{$cache.username|escape}</a></b>&nbsp;&nbsp;</p>
...
<div class="content2-container" style="margin-bottom:8px">
    <table cellspacing="0" cellpadding="0" width="100%">
        ...
        <p style="line-height: 1.6em;">
            ...
            <a id="moreattrs" href="javascript:void(0);" style="float:right;" onClick="javascript:document.getElementById('furtherleft').style.display='block';document.getElementById('furtherright').style.display='block';document.getElementById('moreattrs').style.display='none';">mehr...</a>
            <div id="furtherleft" style="display: none;">
                <p style="line-height: 1.6em;">
                ...
                <p>
                    ...
                    <td style="vertical-align:top">
                        ...
                        <div id="furtherright" style="display: none;">
                        <p style="line-height: 1.6em;">
                    ...
                    <tr>
                        <td colspan="2" style="border-top: 1px solid lightgrey; padding-top: 20px;">

            {if $attributes|@count || $cachelists|@count}
                <div>
                    {if $cachelists|@count}
                        <div style="float:right; margin-bottom:12px; padding-left:16px; {if $attributes|@count}border-left:1px solid #c0c0c0{/if}">
            ...
            <td style="text-align:right; vertical-align: top;">
                ...
                <p class="content-title-noshade-size2" style="margin-right: 0px;">
                    <b><nobr>{$coordinates.lat|escape}&nbsp;{$coordinates.lon|escape}</nobr></b> <span class="content-title-noshade-size0">(<a href="javascript:void(0)" onclick="window.open('coordinates.php?lat={$cache.latitude}&lon={$cache.longitude}&popup=y&wp={$cache.wpoc}&country={$cache.countryCode}&desclang={$cache.desclanguage}','{t escape=js}Coordinates{/t}','width=280,height=550,resizable=no,scrollbars=1')">WGS84</a>)</span><br />  {* Ocprop: <b><nobr>([N|S].*?)&#039;<\/nobr> <nobr>([E|W].*?)&#039;<\/nobr><\/b>.*?WGS84 *}
                </p>
                {if $safariCache}
                ...
                {else}
                    ...
                    {else}
                        <img src="{$cachemap.url}" height="185px" width="185px" style="border: 1px solid gray; border-radius: 5px;"/>
                    {/if}
                    </a>
