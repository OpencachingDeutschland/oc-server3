 ...
 ***************************************************************************/
    ...
    if ($action == 'selectlang') {
        ...
        scan();
    } elseif ($action == 'scanstart') {
        scanStart();
        exit;
    } elseif ($action == 'scanfile') {
        ...
        } elseif ($action == 'quicknew') {
            $cookie->set('translate_mode', 'new');
        } elseif ($action == 'quickall') {
