 ...
 ***************************************************************************/
    ...
    if ($record['password'] == null || $record['email'] == null || $record['is_active_flag'] != 1) {
        ...
        } elseif ($record['last_login'] >= mktime(0, 0, 0, date("m")-6, 1, date("Y"))) {
            $tpl->assign('lastlogin', 2);
        } elseif ($record['last_login'] >= mktime(0, 0, 0, date("m")-12, 1, date("Y"))) {
            $tpl->assign('lastlogin', 3);
        } elseif ($record['last_login'] >= mktime(0, 0, 0, date("m")-24, 1, date("Y"))) {
