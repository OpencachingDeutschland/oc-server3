...
class MenuSubscriber implements EventSubscriberInterface
{
    ...
    public function onSetupMenu(KnpMenuEvent $event)
    {
        ...
        $this->addMenuItem($menu['menuSearch'], 'menuCoordinatesConverter', $this->translator->trans('Convert coordinates'), 'app_coordinates_converter', 'icon', 'fas fa-search-location');
