...
/**
 */
class SupportControllerBackoffice extends AbstractController
{
    //  0 - frisch importiert
    ...
    {
        return $this->render('backoffice/support/index.html.twig');
    }
    ...
    public function searchCachesAndUser(Request $request): Response
    {
        ...
        return $this->render(
                'backoffice/support/searchedCaches.html.twig', [
    ...
    {
        return $this->render('backoffice/support/reportedCaches.html.twig');
    }
    ...
    public function listBonusCaches(): Response
    {
        ...
        return $this->render(
                'backoffice/support/bonusCaches.html.twig', [
                        'supportCachesForm' => $formSearch->createView(),
    ...
    public function listDbQueries(Request $request): Response
    {
        ...
        return $this->render(
                'backoffice/support/databaseQueries.html.twig', [
                        'supportCachesForm' => $formSearch->createView(),
    ...
    public function list_cache_history(string $wpID): Response
    {
        ...
        return $this->render(
                'backoffice/support/cacheHistory.html.twig', [
                        'supportCachesForm' => $formSearch->createView(),
    ...
    public function occPage(string $wpID, int $userID): Response
    {
        ...
        return $this->render(
                'backoffice/support/occ.html.twig', [
                        'supportCachesForm' => $formSearch->createView(),
    ...
    public function vandalism(string $wpID, int $userID): Response
    {
        ...
        return $this->render(
                'backoffice/support/vandalism.html.twig', [
    ...
    public function vandalismRestore(Request $request): Response
    {
        ...
        return $this->render(
                'backoffice/support/vandalismFinish.html.twig',
    ...
    public function executeUAD_actions(Request $request, int $userID): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->getClickedButton() === $form->get('button_account_inactive')) {
                ...
                if ($this->auth->isGranted('ROLE_SUPPORT_HEAD') && !$userToBlockIsHigher) {
    ...
    public function GPX_import(Request $request): Response
    {
        ...
        return $this->render(
                'backoffice/support/occ_gpx_import.html.twig', [
                        'supportCachesForm' => $formSearch->createView(),
