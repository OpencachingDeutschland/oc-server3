...
class CacheDescRepository extends ServiceEntityRepository
{
    ...
    public function getDatabaseArrayFromEntity(GeoCacheDescEntity $entity): array
    {
        return [
            ...
            'desc'             => $entity->desc,
            'desc_html'        => (int)$entity->descHtml,
            'desc_htmledit'    => (int)$entity->descHtmledit,
            'hint'             => $entity->hint,
            'short_desc'       => $entity->shortDesc,
            'desc_dark_unsafe' => (int)$entity->descDarkUnsafe,
        ];
    }
    ...
    public function getEntityFromDatabaseArray(array $data): GeoCacheDescEntity
    {
        ...
        $entity->descHtml       = (bool)(int)$data['desc_html'];
        $entity->descHtmledit   = (bool)(int)$data['desc_htmledit'];
        $entity->hint           = (string)$data['hint'];
        $entity->shortDesc      = (string)$data['short_desc'];
        $entity->descDarkUnsafe = (bool)(int)$data['desc_dark_unsafe'];
