...
const CacheIcon_drivein = L.icon({
    iconUrl: '/images/cacheTypes/drivein-active-untried.svg',
...
const CacheIcon_event = L.icon({
    iconUrl: '/images/cacheTypes/event-active-untried.svg',
...
const CacheIcon_mathe = L.icon({
    iconUrl: '/images/cacheTypes/mathe-active-untried.svg',
...
const CacheIcon_moving = L.icon({
    iconUrl: '/images/cacheTypes/moving-active-untried.svg',
...
const CacheIcon_multi = L.icon({
    iconUrl: '/images/cacheTypes/multi-active-untried.svg',
...
const CacheIcon_mystery = L.icon({
    iconUrl: '/images/cacheTypes/mystery-active-untried.svg',
...
const CacheIcon_tradi = L.icon({
    iconUrl: '/images/cacheTypes/traditional-active-untried.svg',
...
const CacheIcon_unknown = L.icon({
    iconUrl: '/images/cacheTypes/unknown-active-untried.svg',
...
const CacheIcon_virtual = L.icon({
    iconUrl: '/images/cacheTypes/virtual-active-untried.svg',
...
const CacheIcon_webcam = L.icon({
    iconUrl: '/images/cacheTypes/webcam-active-untried.svg',
