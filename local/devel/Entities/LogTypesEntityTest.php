...
class LogTypesEntityTest extends AbstractModuleTest
{
    public function testEntity()
    {
        ...
        $entity->permission = md5(time());
        $entity->cacheStatus = mt_rand(0, 100);
        $entity->de = md5(time());
        $entity->en = md5(time());
        $entity->iconSmall = md5(time());
        $entity->allowRating = mt_rand(0, 100);
        $entity->requirePassword = mt_rand(0, 100);
        $entity->maintenanceLogs = mt_rand(0, 100);
