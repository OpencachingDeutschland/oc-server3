...
*/
            ...
            while ($xmlReader->read() && ($nRecursionLevel > 0)) {
                ...
                } elseif ($xmlReader->nodeType == XMLReader::CDATA) {
                    if ($sSubElement != '') {
                        $node[$elementName][$sSubElement]['__DATA'] = $xmlReader->value;
                    } else {
                        $node[$elementName]['__DATA'] = $xmlReader->value;
