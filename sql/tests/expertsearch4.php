 ...
 * User: Team A
 */
sql('CREATE TEMPORARY TABLE remove_caches (`cache_id` INT(11) NOT NULL, PRIMARY KEY (cache_id)) ENGINE=MEMORY');
sql(
    'INSERT INTO remove_caches SELECT DISTINCT result_caches.cache_id cache_id FROM result_caches, cache_logs WHERE result_caches.cache_id=cache_logs.cache_id AND cache_logs.user_id IN (101254, 101301)'
);
